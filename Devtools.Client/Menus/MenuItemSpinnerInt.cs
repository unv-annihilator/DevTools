...
namespace Devtools.Client.Menus {
    public class MenuItemSpinnerInt : MenuItemSpinner {
        public MenuItemSpinnerInt(Client client, Menu owner, string label, int defaultValue, int min, int max, int step, bool modulus = false,
            int priority = -1) : base(client, owner, label, defaultValue, min, max, step, modulus, priority) {
        }
