...
namespace Devtools.Client.Controllers {
    public class PlayerMenu : Menu {
        ...
        private readonly MenuItemSpinnerInt _wantedItem;
        ...
        public PlayerMenu(Client client, Menu parent) : base("Player Menu", parent) {
            ...
            gaw.Activate += () => {
                foreach (WeaponHash weapon in Enum.GetValues(typeof(WeaponHash))) Game.PlayerPed.Weapons.Give(weapon, 250, false, true);
                return Task.FromResult(0);
            };
            Add(gaw);
            ...
            var neverWanted = new MenuItemCheckbox(client, this, "Never Wanted", NeverWanted) {IsChecked = () => NeverWanted};
            ...
            var godMode = new MenuItemCheckbox(client, this, "God Mode") {IsChecked = () => Game.PlayerPed.IsInvincible};
            godMode.Activate += () => {
            ...
            var ragdoll = new MenuItemCheckbox(client, this, "Can Ragdoll") {IsChecked = () => Game.PlayerPed.CanRagdoll};
            ragdoll.Activate += () => {
        ...
        private Task OnTick() {
            try {
                ...
                if (InfiniteStamina) Function.Call(Hash.RESTORE_PLAYER_STAMINA, Game.Player.Handle, 1f);
